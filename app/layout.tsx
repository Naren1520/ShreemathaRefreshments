  ...
  return (
    <html lang="en">
       <body className={`${playfair.variable} ${cormorant.variable} ${dmSans.variable} font-dmsans bg-black text-cream overflow-x-hidden antialiased md:cursor-none`}>
        <CartProvider>
          <Cursor />
          <a href="https://wa.me/+919900827864" className="fixed bottom-8 right-8 z-[200] bg-[#25d366] w-14 h-14 rounded-full flex items-center justify-center no-underline shadow-[0_4px_20px_rgba(37,211,102,0.4)] animate-float md:cursor-none" title="Chat on WhatsApp">
